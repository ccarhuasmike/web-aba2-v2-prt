...
export class MiscDemo implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.interval = setInterval(() => {
            // Generar número aleatorio seguro de 1 a 10
            const randomIncrement = this.getSecureRandomInt(1, 10);
            this.value += randomIncrement;
    ...
    // Método auxiliar para generar números aleatorios seguros
