...
@Component({
  selector: 'app-parametro-ahorro-edit',
  templateUrl: './parametro-ahorro-edit.component.html',
  styleUrls: ['./parametro-ahorro-edit.component.scss'],
  standalone: true,
  imports: [ParametroEditComponent],
  providers: [MessageService, DialogService, ConfirmationService],
})
export class ParametroAhorroEditComponent extends ParametroEditBaseComponent implements OnInit {

 constructor(
    private readonly servicio: ParametroAhorroService,
    fb: FormBuilder,
