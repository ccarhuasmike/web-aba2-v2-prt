...
import { ParametroAhorroAddComponent } from './parametro-ahorro-add/parametro-ahorro-add.component';
import { ParametroAhorroEditComponent } from './parametro-ahorro-edit/parametro-ahorro-edit.component';
import { ConfirmDialogModule } from 'primeng/confirmdialog';
import { finalize } from 'rxjs';

@Component({
    selector: 'app-parametro-ahorro',
    templateUrl: './parametro-ahorro.component.html',
    styleUrls: ['./parametro-ahorro.component.scss'],
...
export class ParametroAhorroComponent implements OnInit {
    data: any[] = [];
    rows = 10;
    ...
    goToAddParametro() {
        this.dialog.open(ParametroAhorroAddComponent, {
            header: 'Registrar parámetro de Ahorro',
            width: '50vw',
            modal: true,
    ...
    goToEditParametro(parametro: any) {
        this.dialog.open(ParametroAhorroEditComponent, {
